...
INSERT INTO `tappe` VALUES (11,'Piazza IV Novembre','Monumento ai Caduti','Il Monumento ai Caduti della prima guerra mondiale di Ancona si trova in piazza IV Novembre, nel rione del Passetto. È posto al termine del lungo viale della Vittoria ed è collegato alla sottostante spiaggia del Passetto attraverso un''ampia scalinata.Fu progettato negli anni venti, assieme alla Scalinata del Passetto, dall''architetto anconetano Guido Cirilli in forma di un tempio circolare.La costruzione ha otto colonne scanalate, è posta al di sopra di una scalinata circolare concentrica ed è realizzata interamente in pietra d''Istria. Il basamento è decorato con elmi e spade, simboli rispettivamente di difesa e di attacco. Al centro si trova un piccolo altare.Il Monumento fu inaugurato nel 1930, in piena epoca fascista.');
INSERT INTO `tappe` VALUES (12,'Parco Posatora','Parco Posatora','Il parco Belvedere è compreso nel rione di Posatora ed offre un''ottima vista sul mare, sul porto e su tutto il nucleo del centro storico della città. Una leggenda narra che proprio qui gli angeli avrebbero posato la Santa Casa, in viaggio verso Loreto, per riposarsi (da questo fatto prende il nome il rione posa et ora).');
INSERT INTO `tappe` VALUES (13,'Parco della Cittadella','Parco della Cittadella','Ad Ancona, sulla sommità del colle Astagno ed all''interno dell''antico campo trincerato si trova il Parco della Cittadella, che prende il nome dall''adiacente Cittadella, cinquecentesca, sovrastante la città ed il porto di Ancona.Il parco venne aperto negli anni Settanta ed inizialmente era collegato alla Cittadella vera e propria con una scala.');
INSERT INTO `tappe` VALUES (14,'Parco del Pincio','Parco del Pincio','Il Parco del Pincio, piccolo, ma di grande importanza storica dato che è il più antico della città, essendo sorto dopo la presa di Roma del 1870. Il nome ricorda infatti il famoso Pincio della capitale, nel quale Mazzini fece porre le statue degli Italiani più celebri. Per rievocare il suo omonimo romano, il Pincio di Ancona è ricco di sempreverdi, ha un impianto geometrico dei sentieri ed ha un belvedere da cui si gode di un''ampia vista sulla città.');
INSERT INTO `tappe` VALUES (15,'Parco del Cardeto','Parco del Cardeto','Il Parco del Cardeto è il più vasto parco urbano di Ancona. A picco sul mare, occupa le sommità dei colli Cappuccini e Cardeto e si estende in un''area di circa 35 ettari, tutti a ridosso del centro.');
INSERT INTO `tappe` VALUES (16,'Terrazza del Passetto','Terrazzo del Passetto','Una bellissima terrazza che si affaccia sul mare collegata alla scalinata più famosa e maestosa di Ancona che dal monumento dei Caduti conduce alla spiaggia cittadina del Passetto, dove trovate le suggestive grotte dei pescatori dalle porticine in legno colorate e la Seggiola del Papa.Vista dal mare la scalinata prende la forma di un’aquila dove il Monumento ai Caduti ne rappresenta la corona.');
INSERT INTO `tappe` VALUES (17,'Banchina Giovanni da Chio 28','Museo Tattile Statale Omero','Il Museo tattile statale Omero di Ancona è uno dei pochi musei tattili al mondo dove conoscere l''arte attraverso la sorprendente prospettiva delle mani. Nato per promuovere l''integrazione delle persone con disabilità visiva è uno spazio innovativo e piacevole per tutti. L''ingresso è gratuito.');
INSERT INTO `tappe` VALUES (18,'Piazzale della Repubblica','Teatro delle Muse','Il Teatro delle Muse di Ancona è, tra i teatri in cui attualmente si tengono stagioni liriche, il 13º in Italia per capienza, è inoltre il più grande teatro delle Marche.L''edificio, in stile neoclassico, è stato inaugurato nel 1827 ed è opera dell''architetto Pietro Ghinelli. Sul timpano è presente un bassorilievo allegorico che ne spiega il nome, opera dello scultore neoclassico Giacomo De Maria. Vi sono raffigurate le nove Muse, dalle quali il teatro prende il nome, e tra esse è rappresentato anche Apollo, dio delle arti, e Palemone, dio dei porti.');
INSERT INTO `tappe` VALUES (19,'Via Pizzecolli 9','Museo del Giocattolo','Il Museo dell''Infanzia, ideato e creato da Gabriele Schiavoni nel 1994, dopo varie sedi ed esposizioni itineranti, ha ora la sua sede nel centro storico di Ancona.Il museo ripercorre la storia del giocattolo e la storia dell''infanzia, dall''antichità all''Ottocento romantico e pre-industriale, fino ad arrivare agli anni del boom economico. Bambole in biscuit, antichi orsi, automobiline di latta, soldatini in pasta, ricami, abiti, fotografie e tanti altri oggetti d''epoca potranno essere ammirati durante la visita.Tra gli oggetti più importanti un''opera giovanile dello scultore Medardo Rosso raffigurante una testa di bambino in cera.Di ultima creazione la Libreria Storica dell''Automobile con un catalogo di 2000 libri  concernenti le più prestigiose marche automobilistiche italiane e straniere che hanno fatto la storia, alcuni dei quali firmati da personalità di spicco del settore e in edizione limitata.');
INSERT INTO `tappe` VALUES (20,'Via Ferretti 6','Museo Archeologico delle Marche','Il Museo archeologico nazionale delle Marche si trova ad Ancona, all''interno del cinquecentesco palazzo Ferretti. Documenta in modo pressoché completo la preistoria e la protostoria del territorio marchigiano, comprende ricche collezioni relative alla civiltà greca, romana e a quella dei Galli Senoni. I reperti relativi alla civiltà picena formano la più completa raccolta esistente, per la ricchezza delle sue collezioni il museo è uno dei più importanti musei archeologici d''Italia.');
INSERT INTO `tappe` VALUES (21,'Via Mario Torresi 18','Zucchero a velò','Zucchero a Velò nasce dalla passione di Elisabetta per il cibo e per l’american bakery e di Gabriele per le due ruote: Zucchero a Velò è il primo Bike Café di Ancona e, proprio per la sua natura,  parla di cibo, dolci e di biciclette.');
INSERT INTO `tappe` VALUES (22,'Via Benincasa 7','Pizzeria l''Arte della Pizza','L''Arte della pizza ad Ancona è una pizzeria aperta tutti i giorni, ed è il luogo ideale per un pranzo veloce, una cena gustosa o un aperitivo con gli amici. Il personale sempre accogliente, sarà a vostra disposizione anche per ottime pizze da asporto.');
INSERT INTO `tappe` VALUES (23,'Corso Giuseppe Mazzini 96','Bontà delle marche','Solo le eccellenze della tradizione enogastronomica marchigianae italiana, prodotti di qualità superiore, selezionati con cura.Piaceri per il palato e per l’anima. Vini D.O.C e D.O.C.G.,una ricca selezione di distillati, una selezione incredibile di pietanze d’asporto per tutti i gusti e per ogni necessità,dal single alla famiglia.');
INSERT INTO `tappe` VALUES (24,'Via Fabio Filzi 2','Ristorante Il Giardino','Pizza e pietanze di pesce in un locale elegante all''interno di un palazzo del ''700 con veranda e giardino.');
INSERT INTO `tappe` VALUES (25,'Piazza IV Novembre','La Luna al Passetto','Ristorante specialità pesce situato sulla palafitta nella spiaggia del Passetto, in pieno centro di Ancona.');
