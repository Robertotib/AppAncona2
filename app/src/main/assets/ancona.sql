...
INSERT INTO `punti_interesse` VALUES (10,'Parco Posatora','Parchi e Natura','Parco Posatora','Opera di Aristodemo Costoli, noto scultore risorgimentale. Sul basamento della statua, due bassorilievi rappresentano rispettivamente il Congresso di Parigi e la Proclamazione del Regno d''Italia ossia due momenti fondamentali dell''azione politica di Cavour.','android.resource://com.example.test.appancona/drawable/posatora');
INSERT INTO `punti_interesse` VALUES (11,'Lanterna Rossa di Ancona','Parchi e Natura','Lanterna Rossa di Ancona','Una lanterna ma è rossa a causa edel sangue dei nemici di Diego Milito','android.resource://com.example.test.appancona/drawable/lanterna');
INSERT INTO `punti_interesse` VALUES (12,'Terrazza del Passetto','Parchi e Natura','Terrazza del Passetto','terrazza che da sul mare','android.resource://com.example.test.appancona/drawable/terrazza');
