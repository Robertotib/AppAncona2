...
INSERT INTO `punti_interesse` VALUES (9,'Parco della Cittadella','Parchi e Aree Verdi','Parco della Cittadella','Ad Ancona, sulla sommità del colle Astagno ed all''interno dell''antico campo trincerato si trova il Parco della Cittadella, che prende il nome dall''adiacente Cittadella, cinquecentesca, sovrastante la città ed il porto di Ancona.
Il parco venne aperto negli anni Settanta ed inizialmente era collegato alla Cittadella vera e propria con una scala.','android.resource://com.example.test.appancona/drawable/cittadella');
...
In seguito al terremoto del 1930, la parte superiore della facciata venne alterata per riparare ai danni. Durante i bombardamenti della Seconda guerra mondiale la chiesa venne nuovamente danneggiata e fu riaperta al culto nel 1948. ','android.resource://com.example.test.appancona/drawable/sandomenico');
INSERT INTO `punti_interesse` VALUES (15,'Chiesa di Santa Maria della Piazza','Monumenti Religiosi','Piazza Santa Maria','La chiesa di Santa Maria della Piazza si trova ad Ancona in piazza Santa Maria, nell''antico rione Porto.
Eretta tra il XI e XII secolo, è un notevole esempio di stile romanico. Essa fu costruita su una chiesa paleocristiana del IV secolo restaurata nel VI; una parte del pavimento della chiesa attuale è in vetro per permettere la visione dei mosaici paleocristiani sottostanti.','android.resource://com.example.test.appancona/drawable/santamaria');
INSERT INTO `punti_interesse` VALUES (16,'Teatro delle Muse','Luoghi Culturali','Piazzale della Republica','Il Teatro delle Muse di Ancona è, tra i teatri in cui attualmente si tengono stagioni liriche, il 13º in Italia per capienza; è inoltre il più grande teatro delle Marche.
...
INSERT INTO `punti_interesse` VALUES (17,'Teatro Sperimentale','Luoghi Culturali',' Via Redipuglia 59','Edificio moderno costruito nel 1962 eristrutturato a cavallo tra gli anni ’70 e ’80,ospita regolarmente stagioni di prosa, teatroper l’infanzia, serate musicali, convegni e conferenze.
Accoglie allo stesso tempo attività amatoriali di associazioni Onlus, compagnie locali,scuole di danza ecc.
La sala costituita di un’unica plateadegradante, conta 427 posti a sedere, più 5posti per disabili accessibili con ascensoreriservato.
L’acustica perfetta e l’ottima visibilità dellascena da tutti i punti della platea, incontrano l’approvazione del pubblico edegli artisti.','android.resource://com.example.test.appancona/drawable/teatrosperimentale');
